		   ...
		   // DATOS VEHICULOS
			...
			var j = 1;
		         ...
		         //console.log("Carro: "+serial+ "  Len Coord: "+coord.length+" Valor:"+valor.length);
 	                 ...
 	                 if (pos === 0) { cadJson = cadJson + "["; lat = parseFloat(coord[0]); long = parseFloat(coord[1]);cadJson = cadJson + "\"" + lat + "," + long +"\",";} else if (pos >= ((valor.length)-1)) { lat = parseFloat(coord[0]); long = parseFloat(coord[1]); cadJson = cadJson + "\"" + lat + "," + long +"\"";
